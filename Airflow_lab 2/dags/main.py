...
dag  = DAG('Airflow_Lab2_test', 
           ...
           tags=['example'],
           owner_links={"Sheela Hansda": "https://github.com/SheelaHansda/MLOps-Labs"}         
)
...
send_email = EmailOperator(
    task_id='send_email',
    to='sheela1391@gmail.com',    # Email address of the recipient
